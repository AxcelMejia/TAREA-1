...
typedef union             /* Declaración de la unionfpago. */
{
 ...
 typedef struct            /* Declaración de la estructuradomicilio. */
 {
  ...
  typedef struct           /* Declaración de la estructuravendedor. */
  {
   ...
   void F4(vendedor *, int);
    ...
    /* Esta función se utiliza para leer un arreglo unidimensional de tipo estructura vendedorde Telementos. */
    {
        int I, J;
        for (I=0; I<T; I++)
        {
