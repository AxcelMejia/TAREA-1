 ...
 typedef struct               /* Declaración de la estructura producto. */
{
 ...
 /* Esta función se utiliza para manejar las venta a un cliente. Se ingresan productos y cantidades, el fin de datos está dado por el cero.
...
Dado que los productos se encuentran ordenados por clave, puede suceder que al insertar un nuevo producto haya que mover los elementos del arreglo para que continúen ordenados. */
{
    int CLA, I, J;
    printf("\nIngrese clave del producto -0 para salir-: ");
    scanf("%d", &CLA);
 ...
 /* Esta función se utiliza para escribir la información almacenada en —el inventario— un arreglo unidimensional de tipo estructura productode T elementos. */
 {
      int I;
      for(I=0; I<T; I++)
      {
