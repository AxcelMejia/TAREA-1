...
void main(void)
{
    ...
    En este caso se copia la cadena cad0 a cad1. Si el espacio reservado para cad1 es menor que el de cad0, se genera un error en la ejecución del programa. */
    ...
    Si el espacio reservado para cad2 es menor que lo que se pretende copiar, se genera un error en la ejecución del programa. */
    ...
    printf("\nPrueba de la funcion strcat. Se incorpra la cedena cad3 a cad0: %s\n", cad0);
    ...
    /* La función strncat permite incorporar un número determinado de caracteres a una cadena. En este caso se agregan cuatro caracteres de la cadena cad0 a cad2.
    ...
    Si la encuentra, regresa un apuntador al inicio de la primera ocurrencia de la cadena localizada. De otra forma, regresa NULL. */
